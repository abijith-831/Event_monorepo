...
const CardView :React.FC<CardViewProps> = ({events, onDelete}) => {
  return (
    <div className="flex gap-4 overflow-x-auto h-full pb-4 scrollbar-hide scroll-smooth snap-x snap-mandatory">
        {events.map((ev, idx) => (
            <div key={idx} className="bg-gradient-to-b from-gray-100 to-gray-200 hover:bg-gradient-to-t hover:from-gray-100 hover:to-gray-200 p-4 border border-gray-200 relative rounded shadow w-60 h-72 flex-shrink-0">
